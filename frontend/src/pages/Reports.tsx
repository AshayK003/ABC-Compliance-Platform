            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-4">
              <div>
                ...
                <p className="font-body-sm text-body-sm text-on-surface-variant mt-1">
                  Generate, preview, and export high-density compliance data.
                </p>
              </div>
              ...
              <div className="xl:col-span-4 bg-surface border border-outline-variant rounded-lg p-5">
                ...
                <div className="space-y-2">
                  {loading ? (
                    <div className="space-y-2">
                      {[1, 2, 3, 4].map(i => (
                        <div key={i} className="w-full h-24 bg-surface-container-highest border border-outline-variant rounded animate-pulse"></div>
                      ))}
                    </div>
                  ) : templates.length === 0 ? (
